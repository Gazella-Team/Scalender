    ...
    return (
        <section className="h-100 py-[140px] border-b">
            ...
            <div className="w-[90%] mx-auto max-w-[1200px] text-center">
                ...
                <p className="text-gray-600 max-w-[500px] mx-auto mb-12">We book you 6-12 qualified sales meetings a month at a performance basis with the newest AI marketing-technology</p>
